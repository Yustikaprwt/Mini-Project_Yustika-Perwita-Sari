...
class DetailEyeShadow extends StatefulWidget {
  final Map<String, dynamic> product;

  DetailEyeShadow({required this.product, Key? key}) : super(key: key);

  @override
  State<DetailEyeShadow> createState() => _DetailEyeShadowState();
}

class _DetailEyeShadowState extends State<DetailEyeShadow> {
