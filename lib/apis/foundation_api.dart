...
import 'package:mini_project/apis/detail_foundation_api.dart';

class FoundationApi extends StatefulWidget {
  const FoundationApi({Key? key}) : super(key: key);

  @override
  State<FoundationApi> createState() => _FoundationApiState();
}

void navigateToProductDetail(
    BuildContext context, Map<String, dynamic> product) {
  Navigator.of(context).push(MaterialPageRoute(
    builder: (context) => DetailFoundation(product: product),
  ));
}

class _FoundationApiState extends State<FoundationApi> {
  List<Map<String, dynamic>> foundationData = [];
  ...
  Future<void> fetchFoundationApi() async {
    final dio = Dio();
        ...
        child: foundationData.isEmpty
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final item = foundationData[itemIndex];
